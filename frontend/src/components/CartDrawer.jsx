                        ...
                        <div style={{ flex: 1, overflowY: 'auto', padding: '32px' }}>
                            {cart.length === 0 ? (
                                <motion.div
                                    ...
                                    style={{ textAlign: 'center', color: 'rgba(255,255,255,0.4)', marginTop: '80px' }}
                                >
                                    ...
                                    <AnimatePresence initial={false}>
                                        {cart.map(item => (
                                            <motion.div
                                                ...
                                                exit={{ opacity: 0, x: 60, height: 0, marginBottom: -20 }}
                                                transition={{ type: 'spring', stiffness: 320, damping: 30 }}
                                                style={{ display: 'flex', gap: '16px', background: 'rgba(255,255,255,0.03)', padding: '16px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)', overflow: 'hidden' }}
                                            >
                                                <div style={{ width: '64px', height: '64px', background: 'rgba(74,222,128,0.1)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#4ade80', flexShrink: 0 }}>🌿</div>
                                                <div style={{ flex: 1 }}>
